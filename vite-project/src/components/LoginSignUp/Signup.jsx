  ...
  async function handleSignup() {
    try {
      ...
      if (error.response && error.response.status === 404) {
        if (error.response.data.error == "Email already exixt Login again") {
          navigate("/login");
        }
    ...
    <div className={classes.div1}>
      ...
      <form className={classes.form1} onSubmit={handleSubmit}>
        ...
        <div>
          ...
          />
          {invalidFname && <p className={classes.error}>Invalid First Name</p>}
        </div>
        <div>
          <label htmlFor="" className={classes.label}>
            Last name
        ...
        <div>
          ...
          />
          {invalidPassword && <p className={classes.error}>Invalid Password</p>}
        </div>
        <div>
          <label htmlFor="" className={classes.label}>
            Confirm Password
          ...
          <input
            ...
            onChange={(event) => handleChange("cpassword", event.target.value)}
        ...
        <div>
          ...
          />
          {invalidDob && <p className={classes.error}>Invalid Date of Birth</p>}
        </div>
        <div>
          <select
            id="gender"
